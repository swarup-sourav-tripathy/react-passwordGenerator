...
function App() {
  ...
  return (
    <>
      ...
      <h1 className='text-xl md:text-4xl text-center text-white'>Password generator</h1>
      <div className='flex-col justify-center items-center w-auto md:w-2/6 h-20 mx-0 md:ml-96 shadow-md rounded-lg px-4 my-8 py-4 text-3xl text-orange-500 bg-gray-700'>Password generator
